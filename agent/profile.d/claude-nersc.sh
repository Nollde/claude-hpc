# Claude NERSC shell configuration
# Loaded via /etc/profile.d/ for all users

# Colorful prompt — red for root, green for others
if [ "$(id -u)" -eq 0 ]; then
    PS1='\[\e[01;31m\]claude-nersc\[\e[00m\]:\[\e[01;34m\]\w\[\e[00m\] \[\e[90m\]$(date +%H:%M:%S)\[\e[00m\] # '
else
    PS1='\[\e[01;32m\]\u@claude-nersc\[\e[00m\]:\[\e[01;34m\]\w\[\e[00m\] \[\e[90m\]$(date +%H:%M:%S)\[\e[00m\] $ '
fi
